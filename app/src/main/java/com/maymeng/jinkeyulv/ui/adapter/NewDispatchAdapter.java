 ...
 * Describe
 */
public class NewDispatchAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private Context mContext;
    private List<NewDispatchBean.ResponseDataBean> mDatas;
    public boolean isAllLoad = false;


    public NewDispatchAdapter(Context context, List<NewDispatchBean.ResponseDataBean> datas) {
        mContext = context;
        mDatas = datas;
    }
    ...
    private void setDataType1(ViewHolderType1 holder, final int position) {
        ...
        holder.mItemNameTv.setText(bean.CustomerName);
        String phone = "";
